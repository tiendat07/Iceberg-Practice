...
#  && echo "export PYSPARK_DRIVER_PYTHON_OPTS=\"lab --notebook-dir=/home/iceberg/notebooks --ip='0.0.0.0' --NotebookApp.token='123' --NotebookApp.allow_origin='*' --port=8888 --no-browser --allow-root\"" >> /bin/notebook \
